...
class AnalogControl
{
  public:
    ...
    */
    ...
    /** Set a new offset value. The raw value will be offset by this amount
     * before being multiplied by the scale value when calling Process().
     * @param offset New offset value
     * \see VoctCalibration
     */
    void SetOffset(float offset) { offset_ = offset; }

    /** Set a new scale value. The raw value will be multiplied by this amount
     * after being offset by the offset value when calling Process().
